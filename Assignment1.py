...
if(startQuestion == "y"):
        ...
        errors = 0
        corrects = 0
        while errors < 10 and corrects < 10 and username != '':
            starttime = time.time()
        ...
        if(seconds > 60):
            seconds = 0
            minutes += 1
        totaltime = str(minutes) + ':' + str(seconds) + '.' + str(endtime)
        result = {'Username: ': username, 'Time: ': totaltime, 'Score: ': corrects, 'Errors: ': errors}
        print (result)
else:
